...
quote:
  text: >-
    As soon as companies release their data, we want to have it in Fey. With our
    old tool it would take up to a day for them to show up. And with Inngest
    it's almost instant.
  attribution:
    name: Dennis Brotzky
    title: 'CTO, Co-founder'
  avatar: /assets/customers/fey/dennis-brotzky.jpg
companyURL: 'https://www.feyapp.com'
companyDescription: >-
  Fey is a personal finance app that that's making financial research more
  accessible and effortless for anyone.
ogImage: /assets/customers/case-study/og-image-fey.png
---
...
Both features are orchestrated using Inngest's [`step.invoke()`](/docs/reference/typescript/v4/functions/step-invoke), which allows you to asynchronously call another function and handle the result, making it perfect for composing complex workflows with re-usable components.
