---
title: Scaling a fast growing developer email platform with serverless workflows
companyName: Resend
logo: /assets/customers/resend.svg
quote:
  text: >-
    The DX and visibility with Inngest is really incredible. We are able to
    develop functions locally easier and faster that with our previous queue.
    Also, Inngest's tools give us the visibility to debug issues much quicker
    than before.
  attribution:
    name: Bu Kinoshita
    title: Co-founder
...
companyDescription: The modern email sending platform
ogImage: /assets/customers/case-study/og-image-resend.png
---
