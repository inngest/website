---
title: >-
  How cubic reduced false positives by 51% by orchestrating their multi-agent
  system with Inngest
companyName: cubic
logo: /assets/customers/day-ai-logo-2.svg
companyEmployees: 2-20
companyIndustry: SaaS / AI Agents
companyUseCase: Coding Agents
quote:
  text: >-
    Inngest's event and step architecture are essential to cubic. Our Agents
    trigger numerous nested and parallel steps; The ability to string them
    together with good traceability and observability is a game-changer!
  attribution:
    name: Allis Yao
    title: Co-Founder & CEO
  avatar: /assets/customers/cubic/allis.png
companyURL: 'https://www.cubic.dev'
companyDescription: Code Review For The AI Era
ogImage: /assets/customers/cubic/cover.jpg
---
