...
<Blockquote
  text="Used Inngest to add observability to my RAG pipeline — tracking latency, errors, and full input/output logs for every LLM call. Still learning it, but it's already made debugging the pipeline so much easier."
  attribution={{ name: "Vinit Khapekar", title: "Developer" }}
