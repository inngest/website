...
The Inngest SDK's commitment to TypeScript developer experience extends to event validation—supporting Zod 4, Valibot, ArkType, joi, and any Standard Schema-compatible validator, so you can use the validation library that fits your project best.
