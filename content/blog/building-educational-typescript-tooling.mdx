...
**Standard Schema support (September 2025, SDK v3.42.0+):** The Inngest SDK now supports the Standard Schema interface, allowing you to use Zod 4, Valibot, ArkType, joi, or any Standard Schema-compatible validator for event validation. This gives you flexibility to choose the validation library that best fits your project while maintaining full TypeScript type safety. [View changelog](/changelog/2025-09-26-zod-4-standard-schema-support)
