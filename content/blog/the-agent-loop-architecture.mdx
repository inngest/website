...
subtitle: "Everyone's asking \"WTF is a loop?\" Here's the question nobody's asking: what runs the loop?"
image: /assets/blog/the-agent-loop-architecture/featured-image.png
date: 2026-06-22
...
*This article was [originally published on X](https://x.com/djfarrelly/status/2067677007140278630).*
...
<figure>
  <img
    src="/assets/blog/the-agent-loop-architecture/system-overview.png"
    alt="Agent and sidecar architecture diagram showing core agent function, cron function, skill function, and review function"
    className="my-0"
  />
  <figcaption>Agent loop architecture system overview</figcaption>
</figure>
