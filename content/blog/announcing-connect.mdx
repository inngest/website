...
After a few weeks of private alpha, we are happy to rollout Connect as a [Developer Preview](https://docs.inngest.com/docs/release-phases#developer-preview) in our TypeScript, Python and Go SDKs.
...
## Don't trust our words, trust our early users

--
Customer testimonial section
--

If your application is running on servers, or if you are looking for a finer horizontal scaling control or lower latency, give Connect a try and let us know what you think!
