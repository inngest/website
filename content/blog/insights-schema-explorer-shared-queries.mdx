...
These features are available now in the Inngest dashboard. Head to Insights and start exploring schemas inline, and sharing your first query with your team. You can also [query runs, steps, and trace spans](/blog/insights-query-runs-steps-traces?ref=blog-insights-schema-explorer-shared-queries) directly in SQL.
