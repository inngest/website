...
We set a graceful flow termination strategy in the [`onFailure`](/docs/reference/typescript/v4/functions/handling-failures) function (please keep in mind that it's simplified for this blog post).
