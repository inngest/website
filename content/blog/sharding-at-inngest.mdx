...
Similar to our state coordinator rollout, we designed the rollout to occur in multiple stages, affecting various customer segments, starting with Hobby users and ending with enterprise customers. We continue to use this approach for major changes; [our rollout policy explains why and outlines the options available to teams evaluating Inngest](/blog/how-were-rolling-out-new-infrastructure-safely?ref=blog-sharding-at-inngest).
