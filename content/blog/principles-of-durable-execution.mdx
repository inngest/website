...
* **Manages state:** Stores intermediate results and ensures consistency. For latency-sensitive workloads, checkpointing enables near-zero inter-step latency while maintaining durability.
