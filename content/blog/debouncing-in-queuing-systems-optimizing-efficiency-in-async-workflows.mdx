...
For more information on this, check out [our guide on debouncing](/docs/reference/typescript/v4/functions/debounce) or check out [our quick start tutorial](/docs/getting-started/nextjs-quick-start?ref=blog-debounce-in-queueing-systems) to learn the basics of Inngest.
