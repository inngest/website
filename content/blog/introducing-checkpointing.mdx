...
<div className="relative text-lg leading-7 pt-4">
    <span className="absolute left-4 top-0 text-2xl leading-3 text-muted">
        &ldquo;
    </span>
    Using Inngest's Checkpointing, we managed to <strong>bring down the time to process a Shopify order from around 1...</strong>
    <span className="right-6 text-2xl leading-3 text-muted absolute">
        &rdquo;
    </span>
</div>
...
<span className="text-lg">Zamp.com</span>
<br />
...
<div className="relative text-lg leading-7 pt-4">
    ...
    Using Inngest's Checkpointing, we're seeing <strong>3x performance gains</strong> on each function invocation.
    <span className="right-6 text-2xl leading-3 text-muted absolute">
        &rdquo;
    </span>
</div>
