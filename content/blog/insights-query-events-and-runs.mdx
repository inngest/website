...
Today we're excited to announce the public beta of our new **Insights** feature. As of today, all users are now able to access the [Insights Explorer](https://app.inngest.com/env/production/insights?ref=blog-insights-query-events-and-runs), to extract aggregate, actionable intelligence from their account's events and [traces](/blog/insights-query-runs-steps-traces?ref=blog-insights-query-events-and-runs)—using just SQL.
...
No extra data plumbing required—you can [run these queries right from the dashboard](https://app.inngest.com/env/production/insights?ref=blog-insights-query-events-and-runs), right now.
