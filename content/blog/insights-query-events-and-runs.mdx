...
Today we're excited to announce the public beta of our new **Insights** feature. As of today, all users are now able to access the [Insights Explorer](https://app.inngest.com/env/production/insights?ref=blog-insights-query-events-and-runs), to extract aggregate, actionable intelligence from their account's events and (soon) traces—using just SQL.
