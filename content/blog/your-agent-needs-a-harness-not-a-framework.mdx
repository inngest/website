...
To make it multi-player, we're going to explore [swappable sandboxes, external state and memory](/blog/your-agent-architecture-has-a-half-life?ref=blog-your-agent-needs-a-harness-not-a-framework). This would enable Utah to run on serverless if someone wanted to.
