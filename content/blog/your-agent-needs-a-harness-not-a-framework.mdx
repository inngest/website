...
image: /assets/blog/your-agent-needs-a-harness-not-a-framework/utah-harness-architecture.png
date: 2026-03-02
author: Dan Farrelly
...
Utah doesn't hand-roll file I/O and shell execution. It pulls in [`pi-coding-agent`](https://github.com/nicobailon/pi-coding-agent) — battle-tested tool implementations from the OpenClaw/Pi ecosystem:
...
Utah doesn't call the Anthropic SDK directly. It uses [`pi-ai`](https://github.com/nicobailon/pi-ai), a provider-agnostic LLM abstraction that supports Anthropic, OpenAI, and Google. Switching providers is a config change:
