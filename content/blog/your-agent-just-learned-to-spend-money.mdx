...
Before you close this tab, go look at what your own agent does when a tool call fails *after* the API call. If the honest answer is 'it retries and hopes,' you've got a double-charge waiting to happen, and now you know the shape of the fix. The repo has the rest.
