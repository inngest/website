...
Unlike [standard workflows](/docs/learn/inngest-functions?ref=blog-workflow-kit), which have a fixed number of steps, user-defined workflows need to dynamically determine the next steps based on previous actions and user configuration.
...
- **Customizable workflow actions** benefiting from [Inngest steps' features](/docs/learn/inngest-steps?ref=blog-workflow-kit) such as automatic retries, waits, and more.
