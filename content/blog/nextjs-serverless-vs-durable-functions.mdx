...
## How Inngest has evolved: Expanding Durable Functions beyond workflows

Since this article was published, Inngest has extended Durable Functions beyond traditional background workflows, enabling you to add durability directly to API routes and achieve near-zero latency for real-time applications.
