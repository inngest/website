...
## Inngest: Expanding Durable Functions beyond workflows

Inngest extends Durable Functions beyond traditional background workflows, enabling you to add durability directly to API routes and achieve near-zero latency for real-time applications.

### Beyond workflows: step.run() in REST APIs
...
### Near-zero latency with Checkpointing
...
[Learn more about Checkpointing](/docs/setup/checkpointing)
