...
<Blockquote
  text="It's really easy to deploy frontend apps on Vercel, but there's always been this gap for background jobs. Inngest is now filling that gap for a lot of my use cases."
  attribution={{ name: "Patrick DeVivo", title: "Software Engineer & Founder" }}
  sourceUrl="https://www.linkedin.com/posts/patrick-devivo_i-was-skeptical-of-all-the-durable-execution-activity-7320806674724786176-GWKg"
/>
...
Durable Function are composed of 2 main components: [Triggers](/docs/features/events-triggers) and [Steps](/docs/learn/inngest-functions).
