...
<Blockquote
  text="Integrated Inngest for background jobs. First event: feature.request.created. This single event triggers the entire AI pipeline — decouples the API from AI execution completely. Retry support built in. No lost jobs."
  attribution={{ name: "Tejas A.", title: "Developer" }}
