...
Spin up a durable agent with [native AI evals on Inngest](/platform/agent-evals?ref=blog-online-vs-offline-ai-evals-when-to-use-each) and point a scorer at your own production traffic. If you're starting from scratch, this [practical guide to evals in Inngest](/blog/evals-in-inngest-a-practical-guide-to-measuring-and-improving-your-agent?ref=blog-online-vs-offline-ai-evals-when-to-use-each) walks through one metric, deferred scoring, and a first experiment. You can't improve what you can't measure!
