...
Popular use cases are [webhooks](https://www.inngest.com/docs/platform/webhooks), any [Inngest Function](https://www.inngest.com/docs/learn/inngest-functions) reacting to use actions, or AI workflows.
...
A good example would be an [Inngest Function](https://www.inngest.com/docs/learn/inngest-functions) performing some AI enrichment as part of an ETL pipeline. As events arrive, our Inngest Function needs to match OpenAI's API rate limit by reducing the frequency of runs.
...
- **`cancel` mode**: Cancel existing runs and start fresh with the latest data
...
[Learn more about Singleton Functions](/docs/guides/singleton) | [View changelog](https://www.inngest.com/changelog/2025-06-06-singleton-functions)