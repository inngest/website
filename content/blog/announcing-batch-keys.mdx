...
Batch Keys, introduced with the [new `batchEvents.key` option](https://www.inngest.com/docs/reference/typescript/v4/functions/create#batchEvents), enables developers to configure how the batches are composed by leveraging event properties.
