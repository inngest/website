...
Inngest is built around [**durable functions**](https://www.inngest.com/docs/learn/how-functions-are-executed)—code that checkpoints after each [step](https://www.inngest.com/docs/reference/functions/step-run) and resumes from the last successful point after any failure. Three things set it apart for this workload:
