...
## What's new since v3.0: Standard Schema support

Since the v3.0 release, Inngest has added support for the Standard Schema interface (v3.42.0, September 2025), allowing you to use any validation library:
...
[Learn more](/docs/reference/client/create#defining-event-payload-types)
