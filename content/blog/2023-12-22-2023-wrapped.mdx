...
- [Custom failure handling](https://www.inngest.com/docs/reference/typescript/v4/functions/handling-failures),
- [Invoking functions from within a function](https://www.inngest.com/docs/reference/typescript/v4/functions/step-invoke) to compose complex flows,
- [Middleware](https://www.inngest.com/docs/features/middleware/create?guide=typescript) - enabling logging, encryption, tracing, and others,
