...
Its TypeScript SDK provides features ranging from simple background jobs to more [advanced scalable workflows designed for scale](/docs/learn/inngest-functions?ref=blogpost-nextjs-bg-jobs-realtime).
