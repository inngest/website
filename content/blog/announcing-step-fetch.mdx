...
We are thrilled to release [Fetch](/docs/reference/typescript/functions/fetch), a set of new APIs to make durable HTTP requests within an Inngest function.
...
Get started by reading the [Fetch documentation](/docs/reference/typescript/functions/fetch) and by checking out the [examples](/docs/examples/fetch).
