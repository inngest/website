...
**Test your types the way you test your code.** Libraries like [tsd](https://github.com/tsdjs/tsd) let you write assertions about what should and shouldn't compile. If you're shipping types to users, you should have a test suite that covers the cases they'll actually hit—and beware assertions that [look green while asserting almost nothing](/blog/adding-a-second-middleware-broke-our-typescript-types?ref=blog-typescript-types-as-api).
