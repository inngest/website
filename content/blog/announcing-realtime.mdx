...
**Note:** This example uses Zod, but as of SDK v3.42.0 (September 2025), you can use any Standard Schema-compatible validator including Zod 4, Valibot, ArkType, or joi. The `.schema()` method accepts any Standard Schema validator, giving you flexibility in how you validate your realtime messages.
