...
Inngest already powers async workflows at scale with [durable execution in Python](/blog/inngest-python-sdk-durable-background-jobs-for-fastapi-flask-and-django?ref=blog-python-realtime). Unlike Celery or RabbitMQ, you don't need to provision, monitor, or scale queues and workers yourself. Inngest automatically handles scaling, retries, and durability for you.
...
- **New to Inngest?** Check out the [Python quick start guide](/docs/getting-started/python-quick-start?ref=blog-python-realtime)
