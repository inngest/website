...
showSubtitle: true
subtitle: Leverage our new Datadog and Prometheus integrations to build custom metrics and alerting.
date: 2025-06-13
author: Charly Poly
...
Once installed, you can use our [ready-to-use dashboards](/docs/platform/monitor/datadog-integration) to monitor your Inngest functions and build custom alerting:
...
The observability of Inngest Functions is constantly evolving.
...
All Inngest features are built with the community in mind. If you have any feature requests, please vote or submit them on our [roadmap page](/roadmap).