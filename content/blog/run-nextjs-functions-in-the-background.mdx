...
<aside>
  <p>This blog post was updated in February 2023 to reflect the <a href="/docs/getting-started/nextjs-quick-start?ref=blog-run-nextjs-functions-in-the-background">new Inngest JavaScript & TypeScript SDK</a></p>
</aside>
...
// Grab your key here: https://app.inngest.com/env/production/manage/signing-key
