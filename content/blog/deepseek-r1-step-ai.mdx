...
Our AI workflow is built in [TypeScript using Inngest](/docs/reference/typescript/intro?utm_source=koyeb&utm_medium=article&utm_campaign=deepseek-r1), which enables automatic caching and retrying of LLM calls and parallelism. Here are the two primary steps of our multilingual marketing content generator workflow:
