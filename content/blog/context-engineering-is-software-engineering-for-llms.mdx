...
![Prompt Engineering's is now a small subset of building a rich and relevant Agent context.](/assets/blog/context-engineering-is-software-engineering-for-llms/diagram.jpg)
...
- [Windmill built an AI Manager Agent that integrates with companies' tool suite](/customers/windmill) and interacts with employees via Slack to automate reporting.
