...
Like [all of our other handlers](https://www.inngest.com/docs/learn/inngest-functions?ref=blog-redwood-handler#serving), the Redwood handler is simple to use.
...
Check out the [RedwoodJS Framework Guide](/docs/learn/serving-inngest-functions?ref=blog-redwood-handler#framework-redwood) to start your journey, or jump into our [Writing functions](/docs/learn/inngest-functions?ref=blog-redwood-handler) documentation to see what's possible with Inngest!
