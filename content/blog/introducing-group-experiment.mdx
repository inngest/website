...
**[Track outcomes](/docs/patterns/ai-evals/run-experiments-in-production?ref=blog-introducing-group-experiment#track-outcomes).** Experiments tell you which variant ran—to decide which is better, you still need an outcome signal. Use run traces, step latency, and errors for technical outcomes, or [attach your own scores](/blog/introducing-scoring?ref=blog-introducing-group-experiment) and analytics for product and AI-quality comparisons.
