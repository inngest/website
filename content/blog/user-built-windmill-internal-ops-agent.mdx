...
Inngest Connect is available now. If you're running an agent on a long-lived server—a Mac Mini, a container, a VM—it's the straightforward path to triggering it from the outside world without opening your network.
