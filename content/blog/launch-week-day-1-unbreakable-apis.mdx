...
## [Step.Run](https://step.run): The fastest path to durable APIs
...
- **Read the docs** and wrap your first API call with `step.run()`.
...
<CTACallout text={'Want to be among the first to try step.run everywhere with TypeScript support?'} cta={{ href: 'https://www.inngest.com/newsletter?tag=launch-week-day-1-unbreakable-apis', text: 'Join the TypeScript Preview' }} />
