...
**With Inngest:** [You can add cancellation clauses to workflow definitions, and cancellations happen automatically](/docs/features/inngest-functions/cancellation/cancel-on-events):
