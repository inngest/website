...
In late 2022, we launched our [JavaScript/TypeScript SDK](/docs/reference/typescript/intro) to improve the Developer Experience of our tools. This was just the first step towards becoming a truly language-agnostic reliability layer for everyone.
