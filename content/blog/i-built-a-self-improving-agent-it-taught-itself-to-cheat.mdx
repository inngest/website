...
If you want to experiment with the pattern yourself, [**clone the repo**](https://github.com/mitchellalderson/Inngest-Self-Learning-Agent) and swap in your own behavioral prompt.
