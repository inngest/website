...
image: /assets/blog/your-agent-architecture-has-a-half-life/featured-image-v2.png
date: 2026-07-21
...
<Callout>
  ...
  <YouTube id="X1kp-ABIIxQ" title="Your agent architecture has a half-life of 6 months — Dan Farrelly, CTO, Inngest"/>
</Callout>
...
![Layers of the harness: execution, context, compute](/assets/blog/your-agent-architecture-has-a-half-life/harness-layers.png)
...
<Blockquote
  text="I can't even imagine hand-rolling durability and retries. Inngest has been such a time saver."
  attribution={{ name: "Omer Demirkan", title: "Developer" }}
...
![Execution layer overview in relations to the context and compute layers](/assets/blog/your-agent-architecture-has-a-half-life/execution-loop.png)
...
![Execution layer trace with all spans across your run](/assets/blog/your-agent-architecture-has-a-half-life/trace.png)
...
![Loop architecture diagram with cron agent, sub-agents, and review agent](/assets/blog/your-agent-architecture-has-a-half-life/loop.png)
...
![Execution layer as the hub for all data around agent architectures including traces, user feedback, scores, and insights](/assets/blog/your-agent-architecture-has-a-half-life/evals.png)
