...
- **Customizability**. It's difficult and incredibly time intensive to extend basic queueing systems with advanced functionality. Customizations include: changing backoffs function-by-function, cancelling the backlog based off of job data, batching, debounce, singleton execution, smart indexing, and step function parallelism.
