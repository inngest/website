...
<Blockquote
  text="Step-level scoring you can defer until the real signal arrives is a smart primitive for durable agents."
  attribution={{ name: "Rohit Kashyap", title: "Developer" }}
...
- [Evals in Inngest: A Practical Guide](/blog/evals-in-inngest-a-practical-guide-to-measuring-and-improving-your-agent?ref=blog-introducing-scoring)
