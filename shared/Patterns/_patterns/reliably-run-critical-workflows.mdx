...
Inngest lets you compose workflows using [built-in step tools](/docs/learn/inngest-steps?ref=patterns). Each `step.run()` call is independently executed and retried. The following example demonstrates a multi-step AI content pipeline triggered by a document upload:
...
* [Docs: Writing multi-step functions](/docs/learn/inngest-steps?ref=patterns)
* [Docs: Step tools reference](/docs/reference/typescript/v4/functions/step-run?ref=patterns)
* [Patterns: Running functions in parallel](/docs/patterns/running-functions-in-parallel?ref=patterns)
* [Patterns: Building flows for lost customers](/docs/patterns/event-coordination-for-lost-customers?ref=patterns)
