...
subtitle: Handle webhooks and AI model callbacks with fast acknowledgement, at-least-once delivery, and replay.
pattern: jobs
...
Functions can be [deployed to several supported platforms](/docs/apps/cloud?ref=patterns).
