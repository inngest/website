...
export const generateAndPublish = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    // No decision within 48 hours: leave the draft unpublished.
    if (review === null) {
      return;
    }
...
- [Reference: `step.waitForEvent()`](/docs/reference/typescript/v4/functions/step-wait-for-event?ref=patterns)
- [Reference: `step.run()`](/docs/reference/typescript/v4/functions/step-run?ref=patterns)
- [Reference: `step.sleep()`](/docs/reference/typescript/v4/functions/step-sleep?ref=patterns)
