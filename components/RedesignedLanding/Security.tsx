  ...
  return (
    <section className="relative overflow-hidden bg-[#1C1C1C] py-20 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-lg bg-stone-900 p-8 lg:p-12">
          <div className="grid gap-12 lg:grid-cols-[1fr,2fr]">
            {/* Left column */}
            <div>
              <h2 className="mb-6 text-4xl font-light sm:text-5xl">
                Built for <span className="font-normal">trust.</span>
              </h2>
            ...
            <div className="grid gap-x-8 gap-y-10 md:grid-cols-2">
              {features.map((feature, index) => (
                <div key={index} className="border-t border-gray-700 pt-5">
                  <h3 className="mb-3 text-sm font-medium tracking-wider">
                    {feature.title}
                  </h3>
