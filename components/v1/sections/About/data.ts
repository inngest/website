...
export const TEAM: TeamMember[] = [
  ...
  { name: "Pat Holcomb", title: "Head of Growth & Demand Gen", avatar: `${TEAM_PHOTOS_BASE}/pat.png` },
  { name: "John Buchta", title: "Head of Design", avatar: `${TEAM_PHOTOS_BASE}/john.png` },
  { name: "Riley O’Toole", title: "Head of Brand & Experiential", avatar: `${TEAM_PHOTOS_BASE}/rileyo.png` },
...
export const RELATED: RelatedItem[] = [
  ...
  },
  {
    ...
    href: "/blog/announcing-inngest-seed-financing?ref=about",
  },
];
