...
const COVER_IMAGE = "/assets/v1/events/inngest-supper-club-sf.png";

const EVENT = {
  title: "Inngest Supper Club: San Francisco",
  date: "Thursday, August 27, 2026 · 6:00 PM (dinner begins ~6:45 PM)",
  startsAt: "2026-08-27T18:00:00-07:00",
  location: "San Francisco, CA (exact address shared after RSVP approval)",
  description:
    "We're hosting an Inngest Supper Club in San Francisco — a small, low-key dinner for people building agents, workflows, and the infra underneath them.\n\nNo decks, no pitch, no demo before dessert. Just food and conversation with people we like building alongside.\n\nSpace is limited. Request your spot early.",
};

const REGISTER_URL = "https://luma.com/inngest-ew4f?utm_source=events";
...
export default function InngestSupperClubSF() {
