...
const COVER_IMAGE = "/assets/v1/events/inngest-supper-club.png";
...
export default function InngestSupperClub() {
              ...
              {isPastEvent(EVENT) ? (
                ...
                <div className="flex flex-col items-start gap-4">
                  ...
                  <Button asChild variant="accent" className="self-start">
                    <Link href="/events/coffee-chats-with-inngest">
                      Join us for Coffee Chats instead →
                    </Link>
                  </Button>
                </div>
              )}
