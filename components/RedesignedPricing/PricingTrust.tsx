...
export default function TestPricingTrustFeaturesSection() {
  const features = [
    {
      title: "SOC + SAML",
      description:
    ...
    },
    {
      title: "Audit Trails",
      description:
        "Track all actions taken on your account, including API calls and webhooks.",
    },
    {
      title: "SLAS",
  ...
  return (
    <section className="relative flex min-h-[500px] items-end justify-center overflow-hidden text-stone-50 md:min-h-[600px] lg:min-h-[500px]">
      ...
      <div className="relative z-10 w-full">
        <div className="mx-auto max-w-[1222px] px-4 sm:px-6 lg:px-8">
          <div className="bg-stone-900 p-6 lg:py-16">
            <div className="flex flex-col gap-y-8">
              <div className="flex flex-col items-center justify-center text-center">
                <h2 className="mb-4 font-whyte text-3xl font-light tracking-[-2px] sm:text-4xl">
                  Ready for{" "}
                  <span className="font-whyteInktrap font-medium">
                    any enterprise
                  </span>
                </h2>
