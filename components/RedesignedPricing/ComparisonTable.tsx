...
export default function ComparisonTable({ plans, features, sections }) {
  ...
  const renderPlanTabs = () => (
    <div className="sticky top-14 z-10 mb-4 grid grid-cols-4 bg-stone-900 pt-4 md:hidden">
      {plans.map((plan, i) => (
        <button
          key={i}
  ...
  return (
    <div className="bg-stone-900 py-16 text-basis">
      <h2 className="font-whyte-inktrap text-center text-[48px] font-normal leading-[1.2] tracking-[-2.4px] text-[#FAFAF9]">
        Plan features
      </h2>
      {renderPlanTabs()}
