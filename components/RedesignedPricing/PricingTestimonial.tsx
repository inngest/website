...
export default function PricingTestimonial() {
  return (
    // <div className="mx-auto flex max-w-[1222px] flex-col items-center justify-center p-8">
    //   <h3 className="font-whyte-inktrap text-center text-[32px] font-normal leading-[1.4] tracking-[-1.6px] text-[#FAFAF9]">
  ...
  return (
    <div className="relative bg-stone-950 py-24 text-white md:px-4 md:py-48">
      <div className="relative z-10 mx-[calc((100vw-72rem)/2)]">
        <div className="mb-12 flex justify-between gap-4 px-4 md:flex-row md:items-center md:justify-center md:px-0">
          ...
          <div className="flex gap-2 self-end md:hidden md:self-auto">
            <Button
              variant="outline"
              size="icon"
              onClick={scrollPrev}
