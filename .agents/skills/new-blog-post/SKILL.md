---
name: new-blog-post
description: "Prepares files for a new blog post — creates the markdown file in content/blog, writes frontmatter, copies media assets, and sets up a branch. Use when starting a new blog post from a .md/.doc file or raw text."
argument-hint: "[source-file-or-text]"
---
