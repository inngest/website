...
// v1 page (aliased — `ContactForm` above is the legacy form widget).
import ContactFormV1 from "@/components/v1/pages/ContactForm";

// Flag-aware: the v1 page is a "Get in Touch" support hub, the legacy page
// is the sales-demo form — they need different titles.
...
// v1 redesign serves at the canonical /get-in-touch when the flag is on;
// the legacy page below is preserved and renders when it's off (same
// pattern as /about, / and /ai). /contact permanently redirects here.
export default function Page() {
  if (isV1Enabled()) return <ContactFormV1 />;
