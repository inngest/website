...
// and exposes helpers used by both the dynamic /customers/[slug] route
// and the bespoke static studies (day-ai, baerskin-tactical), which flag-
// gate to this v1 render when the flag is on and keep their own design
// when it's off.
...
// Cached per request so generateMetadata + the page render (and the
// dynamic route's notFound check + renderV1Story) parse each MDX file
// once, not 2-3 times.
export const readStudy = cache(
...
export function serializeStudy(content: string) {
