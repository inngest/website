...
export const REPORT_GRAPHS = {
  "confidence-in-scaling-ai-workflows-by-team-size": {
    title: "Most AI teams aren’t confident that their stack can scale",
    description:
  ...
  "most-statistically-significant-signals-for-confidence-in-scaling-ai": {
    title: "The 3 infrastructure signals that predict confidence in scaling AI",
    description:
  ...
  "orchestration-platform-by-team-size": {
    title: "AI orchestration tool choices by engineering team size",
    description:
  ...
  "time-spent-on-reliability-work-teams-building-ai-vs-traditional-software": {
    title: "Reliability work: AI teams vs. traditional software teams",
    description:
  ...
  "whats-driving-reliability-burden-up": {
    title: "What's driving reliability burden up in 2026?",
    description:
  ...
  "what-breaks-teams-building-ai-vs-traditional-software": {
    title: "What causes production incidents - teams building AI vs traditional software",
    description:
  ...
  "agent-framework-adoption-by-team-size": {
    title: "AI agent framework adoption by team size",
    description:
  ...
  "eval-approach-by-team-size": {
    title: "How engineering teams approach AI evals",
    description:
  ...
  "perceived-gaps-in-agent-frameworks": {
    title: "Perceived gaps in AI agent frameworks",
    description:
  ...
  "whats-unsolved-by-team-size": {
    title: "The #1 unsolved problem for engineering teams",
    description:
