...
// Legacy /security body, rendered when the v1 flag is off. Ported verbatim
// from the old Pages-Router page (pages/security.tsx); Header/Footer now
// come from the app layout's legacy chrome, so only the body lives here.
export default function SecurityLegacy() {
  return (
    <Container>
      <article>
        <main className="m-auto max-w-[80ch] pt-16">
          ...
          <div className="prose-invert prose mx-auto my-20 text-slate-300 prose-a:font-medium prose-a:text-link prose-a:no-underline prose-a:transition-all hover:prose-a:underline prose-code:bg-slate-800 prose-code:tracking-tight prose-img:rounded-lg">
            ...
            <p>
              ...
              communicated throughout the organization. Our Information Security
              Program follows the criteria set forth by the SOC 2 Framework. SOC
              2 is a widely known information security auditing procedure
              created by the American Institute of Certified Public Accountants.
            </p>

            <h3>Third-Party Audits</h3>
            <p>
              Our organization undergoes independent third-party assessments to
              test our security and compliance controls.
            </p>
            ...
            <p>
              ...
              Program and the protection of our customer’s data are well defined
              and documented. Our team members are required to review and accept
              all of the security policies.
            </p>
            ...
            <p>
              ...
              adhere to an industry standard confidentiality agreement prior to
            ...
            <p>
              ...
              with multiple certifications. For more information on our
              provider’s security processes, please visit{" "}
              <a
            ...
            <p>
              ...
              These databases are all located in the United States. Please
              reference the above vendor specific documentation linked above for
              more information.
            </p>
            ...
            <p>
              ...
              monitoring services to alert the team in the event of any failures
              affecting users.
            </p>
            ...
            <p>
              ...
              authentication (2FA) and strong password policies to ensure access
            ...
            <p>
              ...
              <a href="mailto:security@inngest.com">security@inngest.com</a>. We
              do offer bounties for qualifying, valid reports of system or SDK
              vulnerabilities.
            </p>
            <p>
            ...
            <p>
              In order to ensure security reports are actionable and to prevent
              our security inbox from being inundated with invalid reports,
              please review{" "}
              ...
              <em>"CSRF that requires the knowledge of a secret"</em>, there is
