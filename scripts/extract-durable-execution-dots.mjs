// Extracts the durable-execution hero wireframe pattern into a static
// JSON catalogue of dot centres.
//
// Source: scripts/assets/durable-execution-particles.svg ("Particle46"),
// a 1000×1000 viewBox. Like the observability export, dots are stroked
// `<path>` elements styled with `stroke-dasharray: 0 15` and
// `stroke-linecap: round` — i.e. one round-capped dash every 15 user
...
// every 15 units of accumulated arc length.
//
// Re-run after the design changes:  pnpm v1:extract-de-dots
...
const SOURCE = path.join(
  ROOT,
  "scripts/assets/durable-execution-particles.svg"
);
const OUTPUT_JSON = path.join(
  ROOT,
  "public/assets/v1/durable-execution-hero/dots.json"
);

// Dash period from the stylesheet (`stroke-dasharray: 0 15`).
