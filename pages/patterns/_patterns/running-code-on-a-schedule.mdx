...
After deploying your scheduled function to Inngest [using your preferred platform](/docs/platform/deployment?ref=patterns), you'll be able to view previous run's logs and next run times in the Inngest dashboard.
