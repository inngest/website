...
1. Next to the environment drop down, click the key icon, then "Event keys" ([direct link](https://app.inngest.com/env/production/manage/keys))
...
![A newly created Event Key in the Inngest Cloud dashboard](/assets/docs/platform/manage/event-keys/event-key-list.png)
