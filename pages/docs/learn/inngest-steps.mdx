...
<Callout variant="info">
  **Using inngest@v4?** The TypeScript examples on this page use v3 syntax with three arguments to `createFunction`. In v4, event triggers are specified in the configuration object:
  ```ts
