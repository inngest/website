...
<Callout variant="info">
  You do not need a signing key for local development. When `INNGEST_DEV=1` is set, the SDK skips signature verification and connects to your local Inngest Dev Server.
</Callout>
