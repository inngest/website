...
Deno.serve(serve({
  client: inngest,
  functions: [fnA],
  servePath: "your-function-name",
}));
```
</CodeGroup>

Ensure that `servePath` matches your Supabase Edge Function name. Alternatively, you can set this with the `INNGEST_SERVE_PATH` environment variable.
