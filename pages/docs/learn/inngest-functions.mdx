...
<CardGroup cols={3}>
  ...
  <Card title="Steps" icon={<RiGuideFill className="text-basis h-4 w-4"/>} href={'/docs/learn/inngest-functions'}>
...
<CardGroup cols={2}>
  ...
  <Card title="Workflows" icon={<RiMistFill className="text-basis h-4 w-4"/>} href={'/docs/learn/inngest-steps'}>
...
<CardGroup cols={1}>
  ...
  <Card title="Thinking in Steps" icon={<RiGuideFill className="text-basis h-4 w-4"/>} href={'/docs/learn/inngest-steps'}>
