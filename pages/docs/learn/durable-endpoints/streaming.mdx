...
For all available options (`fetch`, `fetchOpts`, `onMetadata`, `onDone`), see the [full API reference](/docs/reference/typescript/v4/durable-endpoints#client-fetchwithstream).
