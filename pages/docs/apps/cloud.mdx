...
- Functions will be marked as archived but still be visible, including their run history.
...
<img
  src="/assets/docs/apps/apps-cloud-archive-button.png"
  className="rounded-md"
  alt="Inngest Cloud screen with archive app button"
/>

2. Confirm that you want to archive the app by clicking "Yes".

<img
  src="/assets/docs/apps/apps-cloud-archive-modal.png"
  className="rounded-md"
  alt="Inngest Cloud screen with archived app confirmation modal"
/>

3. Your app is now archived. 🎉

<img
  src="/assets/docs/apps/apps-cloud-archived-app.png"
  className="rounded-md"
  alt="Inngest Cloud screen with one app archived"
/>
