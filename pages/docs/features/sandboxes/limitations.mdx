...
- There is no `waitUntilRunning()` helper or dedicated readiness endpoint.
  Poll Get with a bound.
...
- Process List uses opaque cursors with a default of 50 and maximum of 250
  items per page.
