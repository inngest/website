...
Check out the [`step.sleep()` TypeScript reference.](/docs/reference/typescript/v4/functions/step-sleep)
...
Check out the [`step.sleepUntil()` TypeScript reference.](/docs/reference/typescript/v4/functions/step-sleep-until)
...
<Callout variant={'info'}>
  **Sleeps and trace/log history**
  ...
  - Given a function run's ID, you can inspect its status using Inngest Cloud's Quick Search feature (Ctrl-K or ⌘K) or the [REST API](https://api-docs.inngest.com).
</Callout>
