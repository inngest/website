...
export default inngest.createFunction(
  {
    id: "import-item-data"
    triggers: { event: "store/import.requested" },
  },
  async ({ event }) => {
...
export default inngest.createFunction(
  {
    ...
    triggers: { event: "store/import.completed" },
  },
  async ({ event }) => {
    try {
...
inngest.createFunction(
  {
    ...
    triggers: { event: "weather/forecast.requested" },
  },
  async ({ event, step }) => {
    let data;
...
inngest.createFunction(
  {
    id: "generate-summary",
    triggers: { event: "blog/post.created" },
  },
  async ({ attempt }) => {
  ...
  inngest.createFunction(
    {
      ...
      triggers: { event: "app/update-recent-usage" },
    },
    async ({ event, step }) => {
      // ...
