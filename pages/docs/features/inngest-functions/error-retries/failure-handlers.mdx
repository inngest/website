...
/* Option 2: Listens for the [`inngest/function.failed`](/docs/reference/typescript/v4/functions/handling-failures#the-inngest-function-failed-event) system event to catch all failures in the inngest environment*/
inngest.createFunction(
...
# Option 2: Listens for the [inngest/function.failed](/docs/reference/typescript/v4/functions/handling-failures#the-inngest-function-failed-event)
