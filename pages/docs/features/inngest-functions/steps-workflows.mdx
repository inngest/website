...
<CardGroup cols={3}>
  ...
  <Card 
    ...
    title={"TypeScript SDK - Steps API"}
    icon={<TypeScriptIcon />}
  >
  Explore the Steps API available for TypeScript applications.
  </Card>

  <Card 
    href={"/docs/reference/python/steps/invoke"}
    title={"Python SDK - Steps API"}
    icon={<PythonIcon />}
  >
    Use Steps in Python
  </Card>
  ...
  <Card 
    ...
    title={"Go SDK - Steps API"}
    icon={<GoIcon />}
  >
    Write Inngest Functions in Go
  </Card>
