...
You will find instructions to deploy your router on Railway [on this GitHub README.](https://github.com/prisma/prisma-examples/tree/latest/pulse/inngest-router#to-railway)
...
See an example [in this blog post](https://www.prisma.io/blog/build-real-time-durable-workflows-with-pulse-and-inngest#prisma-pulse--inngest-in-practice-building-an-ai-writer-workflow).
