...
Check out some of the best practices below for a quick look at middleware in action:
...
<CardGroup cols={2}>
  ...
  <Card title="Datadog middleware" icon={<CLIIcon />} href={'/docs/examples/track-failures-in-datadog'}>
