...
<Warning>
  ...
  v3 docs at [/docs/reference/typescript/v3/realtime](/docs/reference/typescript/v3/realtime).
</Warning>
...
- Use `publish()` for high-frequency updates like tokens, logs, or progress ticks.
- Use `step.realtime.publish()` for important state transitions and final results.
