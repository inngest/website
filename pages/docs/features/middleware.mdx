...
Middleware is available in the [TypeScript SDK](/docs/reference/typescript/v4/middleware/lifecycle) and [Python SDK](/docs/reference/python/middleware/lifecycle).

Support in the Go SDK is planned.
...
In TypeScript, those stacked transforms also compose at the type level. For a deep dive into how that once went wrong—and how we fixed it—see [Adding a second middleware broke our typescript types](/blog/adding-a-second-middleware-broke-our-typescript-types?ref=docs-middleware).
