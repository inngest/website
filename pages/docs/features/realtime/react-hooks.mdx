...
<Info>
  ...
  with `getSubscriptionToken()` or `inngest.realtime.token()` on the server.
</Info>

<Warning>
  Need the old `useInngestSubscription()` docs? See the archived
  v3 page at
  [/docs/reference/typescript/v3/realtime/react-hooks](/docs/reference/typescript/v3/realtime/react-hooks).
</Warning>
