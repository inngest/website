import { CardGroup, Card, Warning } from "src/shared/Docs/mdx";
...
<Warning>
  This page documents deprecated v3 Next.js streaming patterns based on
  `@inngest/realtime`. For the current v4 approach, see
  [/docs/features/realtime/react-hooks](/docs/features/realtime/react-hooks)
  or [/docs/reference/typescript/v4/realtime/subscribing](/docs/reference/typescript/v4/realtime/subscribing).
</Warning>
