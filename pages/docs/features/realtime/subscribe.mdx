...
<Warning>
  ...
  APIs, see [/docs/reference/typescript/v4/realtime/subscribing](/docs/reference/typescript/v4/realtime/subscribing).
  For archived v3 concepts, see
  [/docs/reference/typescript/v3/realtime](/docs/reference/typescript/v3/realtime).
</Warning>
...
<Steps>
  ...
  <Step title="Subscribe to a channel">
    Once you have a token, you can subscribe to a channel by calling the `subscribe` function with the token. You can also subscribe using the `useInngestSubscription` React hook. Read more about the [archived v3 React hook docs here](/docs/reference/typescript/v3/realtime/react-hooks).
