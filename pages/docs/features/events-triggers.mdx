...
You can also launch a specific function as fire-and-forget background work from inside another run with [deferred functions](/docs/features/inngest-functions/deferred-functions).
...
- Events can be used to synchronize Inngest Function runs with [cancellation](/docs/features/inngest-functions/cancellation) and [“wait for event” step](/docs/reference/typescript/v4/functions/step-wait-for-event).
