...
For more information on writing functions, see the <a href="https://docs.inngest.com/docs/functions">Writing Functions</a> section of the Inngest docs.
