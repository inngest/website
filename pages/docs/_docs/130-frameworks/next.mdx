...
Visit `${your-url}/api/inngest` (usually [http://localhost:3000/api/inngest](http://localhost:3000/api/inngest)) to see the dashboard. If there are any problems detected, they'll show up here.
