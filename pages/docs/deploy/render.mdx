...
* Test this web app locally with the [Inngest dev server](/docs/local-development).
...
Each time you push changes to your Inngest functions, you need to sync your web app with Inngest. For convenience, you can automate these syncs from your CI/CD. See our [programmatic syncing guide](/docs/apps/cloud#programmatically) for more information.
