...
To handle [deployment protection](#bypassing-deployment-protection) in this manual sync option, vercel bypass protection secret key should be added to the app url as a query parameter. Your app url should look like this:

```
https://my-app-preview-url.vercel.app/api/inngest?x-vercel-protection-bypass=BYPASS_SECRET_KEY
```