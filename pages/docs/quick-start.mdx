...
Callout>
👉 Note: If you're using the Next.js App Router, exporting the Inngest client from an API route file will cause a build error. Instead, instantiate the Inngest client in a separate file and import it into your route file.
</Callout>
...
Let's write your first reliable serverless function! Add the following to your `./pages/api/inngest.ts` file:
