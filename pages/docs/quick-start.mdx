...
Inngest invokes your functions securely via an [API endpoint](/docs/sdk/serve) at `/api/inngest`. To enable that, you will create an [Inngest client](/docs/reference/client/create) in your Next.js project, which you will use to send events and create functions.
...
<GuideSection show="nextappdir">
  ...
  In the `/src/inggest` directory create an Inngest client:
