...
A handy little trick: if your event behaved in an odd way, you can either replay it or edit and replay it. Try replaying it by clicking on the "Replay" button in the top center:
