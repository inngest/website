...
<CardGroup cols={2}>
  <Card title="Inngest Dev Server" icon={<InngestIcon className="text-basis"/>} href={'/docs/dev-server'}>
    Start Inngest locally with a single command.
  </Card>
  <Card title="Development with Docker" icon={<RiFunctionFill className="text-basis"/>} href={'/docs/guides/development-with-docker'}>
