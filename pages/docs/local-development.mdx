...
<CardGroup cols={2}>
  <Card title="Inngest Dev Server" icon={<InngestIcon />} href={'/docs/dev-server'}>
    Start Inngest locally with a single command.
  </Card>
  <Card title="Development with Docker" icon={<RiFunctionFill />} href={'/docs/guides/development-with-docker'}>
...
<CardGroup cols={1}>
  <Card title="Can I run the Inngest Dev Server in production?" icon={<RiQuestionFill />}>
  ...
  <Card title="How do I test webhooks locally?" icon={<RiQuestionFill />}>
    Webhooks configured on the Platform [can be sent to the Dev Server](/docs/platform/webhooks#local-development).
  </Card>
  <Card title="How do I work with Stripe or Clerk webhooks locally?" icon={<RiQuestionFill />}>
  ...
  <Card title="Are Crons supported locally?" icon={<RiQuestionFill />}>
  ...
  {/* <Card title="The Dev Server does not locate my local application" icon={<RiQuestionFill />}>
