...
<CardGroup cols={2}>
  <Card title="Inngest Dev Server" icon={<RunsIcon />} href={'/docs/features/event-triggers/send-events'}>
    Send an event from your application’s backend with the Inngest SDK.
  </Card>
  <Card title="Development with Docker" icon={<SquaresIcon />} href={'/docs/guides/scheduled-functions'}>
