...
<CardGroup cols={3}>
  ...
  <Card 
    ...
    title={"Next.js"}
    icon={<RiNextjsFill className="text-basis"/>}
    iconPlacement="top"
  >
...
<CardGroup cols={2}>
  ...
  <Card 
    ...
    icon={<RiGuideFill className="text-basis"/>}
  >
  ...
  <Card 
    ...
    title={"Flow Control"}
    icon={<RiGitPullRequestFill className="rotate-90 text-basis" />}
  >
  ...
  <Card 
    ...
    icon={<InngestIcon className="text-basis"/>}
  >
  ...
  <Card 
    ...
    icon={<RiCloudLine className="text-basis"/>}
  >
