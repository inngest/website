...
<CardGroup cols={3}>
  ...
  <Card
    ...
    iconPlacement="top"
  >
    Connect AI assistants to Inngest Cloud with read-only tools for apps, functions, events, runs, and traces.
  </Card>
  ...
  <Card
    ...
    iconPlacement="top"
  >
    Full Inngest documentation in markdown format for LLM context windows. Also available as a table of contents.
  </Card>
