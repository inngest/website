...
import TanStackStartIcon from 'src/shared/Icons/TanStackStart';
import {
  RiCloudLine,
  RiNextjsFill,
  RiNodejsFill,
...
<CardGroup cols={2}>
  ...
  <Card
    href={"/docs/getting-started/tanstack-start-quick-start?ref=docs-home"}
    title={"TanStack Start"}
    icon={<TanStackStartIcon className="text-basis h-8 w-8"/>}
    iconPlacement="top"
  >
  Build durable workflows in TanStack Start, the modern full-stack React framework.
  </Card>
