import { Callout, Note } from "src/shared/Docs/mdx";

export const description = "Inngest supports OpenTelemetry for distributed tracing and observability. Use the otelMiddleware to automatically instrument your Inngest functions and send spans to your observability platform.";

# OpenTelemetry Usage

Inngest supports OpenTelemetry for distributed tracing and observability across your functions. The `otelMiddleware` automatically instruments your Inngest functions and integrates with your existing OpenTelemetry providers, giving you deep insights into function execution, step timing, and performance. It includes [automatic instrumentation](#instrumentation) for many popular libraries.
