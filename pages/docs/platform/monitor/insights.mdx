...
<Info>
  Insights support is currently in developer preview. Some details including SQL syntax and feature availability are still subject to change during this period. Read more about the developer preview [roadmap here](#roadmap).
</Info>
