...
|----------|-------------|
| `ARRAY_AGG()` / `groupArray()` | [Aggregates values into an array](https://clickhouse.com/docs/sql-reference/aggregate-functions/reference/grouparray) |
...
| `any()` | [Returns an arbitrary value from the group](https://clickhouse.com/docs/sql-reference/aggregate-functions/reference/any) |
| `anyLast()` | [Returns the last value in the group](https://clickhouse.com/docs/sql-reference/aggregate-functions/reference/anylast) |
