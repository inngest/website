...
- **Use AI to generate queries** - Describe what you want in plain English and let the Insights Assistant write the SQL for you
...
Insights Assistant is an AI-powered feature that helps you generate SQL queries using natural language. Instead of writing SQL manually, you can describe what you want to analyze and the assistant will create the query for you.

### How it works

Simply describe what you want to query in plain English, and the Insights Assistant will:
...
<Info>
  Insights Assistant is built using Inngest's own [Realtime API](/docs/features/realtime), [AgentKit](https://agentkit.inngest.com), and durable execution with checkpointing.
</Info>
