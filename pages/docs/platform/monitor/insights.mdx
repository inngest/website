...
You can now access your schemas within the Schema Explorer located on the right side of the insights page. Browser and search your event schemas without leaving the editor. 
...
Search is also available for more efficient filtering of fields. After you have located the field you want, you can click to copy and past it in your SQL editor. 
...
Some queries are valuable to the whole organization and now you can more easily share those across your org. Once you save a query you can select the actions dropdown and share with your organization.
