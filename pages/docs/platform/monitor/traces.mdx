...
Every Inngest function run is automatically traced with no configuration required. Traces are available in both the [DevServer](/docs/local-development) and the Inngest Cloud dashboard, giving you a complete picture of what happened during a function execution, including step timing, queue delays, HTTP connection phases, retry attempts, and input/output data.
...
Actions in the header include [**Rerun**](/docs/platform/manage/rerun-function-runs?ref=docs-traces), **Cancel** (for in-progress runs), and **Invoke** to re-invoke the function.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><div style={{ display: "flex", alignItems: "center", gap: 8 }}><span style={{ flexShrink: 0, width: 60, height: 16, borderRadius: 2, backgroundColor: "#34784c" }} /><span>Status-colored solid bar</span></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><div style={{ display: "flex", alignItems: "center", gap: 8 }}><span style={{ flexShrink: 0, width: 60, height: 16, borderRadius: 2, backgroundColor: "#34784c", backgroundImage: "repeating-linear-gradient(-45deg, transparent, transparent 6px, rgba(255,255,255,0.15) 6px, rgba(255,255,255,0.15) 8px)" }} /><span>Tall bar with diagonal stripe pattern</span></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><div style={{ display: "flex", alignItems: "center", gap: 8 }}><span style={{ flexShrink: 0, width: 60, height: 8, borderRadius: 2, backgroundColor: "#34784c" }} /><span>Short status-colored bar</span></div></td>
    </tr>
    <tr>
...
- <span style={{ color: "#34784c", fontWeight: "bold" }}>Green</span>: Completed successfully
...
- [**Rerun from step**](/docs/platform/manage/rerun-function-runs?ref=docs-traces#rerun-from-a-step) button: re-execute the function starting from this step and optionally replace supported step inputs
