...
![](/assets/docs/platform/monitor/inspecting-function-runs/handle-failed-payments-function-run-failed.png)

Clicking on the failed Function Runs open the Function Run Logs panel:

![](/assets/docs/platform/monitor/inspecting-function-runs/function-run-logs.png)
...
<Col>
![](/assets/docs/platform/monitor/inspecting-function-runs/function-run-logs-timeline-1.png)
</Col>
...
![](/assets/docs/platform/monitor/inspecting-function-runs/function-run-logs-timeline-2.png)
