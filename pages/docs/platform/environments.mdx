...
-   [**Local Environment**](/docs/local-development) leverages the Inngest Dev Server (`inngest dev`) to test and debug functions on your own machine.
