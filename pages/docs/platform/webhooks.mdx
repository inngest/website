import { Callout, Row, Col, Properties, Property } from "src/shared/Docs/mdx";
...
<Callout variant="info">
  💡 Header names are case-insensitive and canonicalized by making the first character and any characters following a hyphen uppercase and the rest lowercase.
