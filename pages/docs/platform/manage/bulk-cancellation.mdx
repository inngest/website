...
<Callout>
  This feature is now generally available. [Read the announcement here](/blog/bulk-cancellation).
</Callout>
...
![The bulk cancellation button can be found from a Function page, in the top right menu.](/assets/docs/platform/manage/bulk-cancellation/function-runs-cancel-button.png)
