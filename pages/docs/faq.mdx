...
After internal testing, Inngest may introduce major infrastructure changes gradually to small cohorts of Hobby accounts before expanding a rollout. Testing with a limited set of real workloads helps us identify behavior that cannot be reproduced internally while reducing the potential blast radius.

Some Hobby accounts may experience temporary degraded performance during a rollout while we monitor and resolve issues. If you are evaluating Inngest and need a more predictable environment, [contact our Sales team](/contact?ref=docs-faq). We can help move your evaluation to infrastructure with stronger performance isolation. Upgrading to [any paid plan](/pricing?ref=docs-faq) automatically moves your account to infrastructure isolated from the Hobby-plan rollout pool.

Read [how we roll out new infrastructure safely](/blog/how-were-rolling-out-new-infrastructure-safely?ref=docs-faq) for more information.
