...
- [Why might my Hobby account experience increased latency?](#why-might-my-hobby-account-experience-increased-latency)
...
## Why might my Hobby account experience increased latency?

After multiple rounds of internal testing, Inngest may introduce major infrastructure changes gradually to small cohorts of Hobby accounts before expanding a rollout to Pro and Enterprise. The Hobby plan is designed for testing and validating workflows rather than production use, so starting with these accounts reduces the risk of disrupting end users. These infrastructure changes are expected to benefit every account; Hobby users receive them first so we can validate behavior that cannot be fully reproduced internally.

Some Hobby accounts may experience temporary degraded performance during a rollout while we monitor and resolve issues. If you are evaluating Inngest and need a more predictable environment, [contact our Sales team](/contact?ref=docs-faq). We can help move your evaluation to infrastructure with stronger performance isolation. Upgrading to [any paid plan](/pricing?ref=docs-faq) automatically moves your account to infrastructure isolated from the Hobby rollout pool.
