...
If you're unable to sufficiently extend the timeout within Vercel, our [streaming feature](https://www.inngest.com/docs/streaming) can help.

## My app's serve endpoint requires authentication. What should I do?
Your app's [serve endpoint](https://www.inngest.com/docs/sdk/serve) needs to be accessible by our
servers, so we can trigger your functions. For this reason, we recommend disabling authentication
for the serve endpoint.

Our servers communicate securely with your app's serve endpoint using your [signing key](https://www.inngest.com/docs/sdk/serve#signing-key).
...
or, if you're on Vercel's Pro plan, [configure protection bypass](https://www.inngest.com/docs/deploy/vercel#bypassing-deployment-protection).
