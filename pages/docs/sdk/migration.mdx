...
# Upgrading from Inngest SDK v3 to v4

The official migration guide can be found in [this Github issue](https://github.com/inngest/inngest-js/issues/1304). All breaking changes are listed there, along with any discussions or suggestions to help ease the burden of migration.
