...
As with custom handlers previously, check out our [custom framework handlers](/docs/sdk/serve#custom-frameworks?ref=migration) section to see how to define your own.
