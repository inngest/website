...
import { RiBracesFill, RiCalendarScheduleFill, RiErrorWarningFill, RiArrowDownDoubleFill, RiWifiFill, RiBarChart2Fill, RiShieldCheckFill, RiCheckboxCircleFill } from "@remixicon/react";
...
>
Make any API endpoint durable with automatic retries.
</Card>
...
<Card
  ...
  icon={<RiCheckboxCircleFill fill={"black"} className="h-6 w45 fill-carbon-700/10 stroke-carbon-700 transition-colors duration-300 group-hover:stroke-carbon-900 dark:fill-white/10 dark:stroke-carbon-400 dark:group-hover:fill-indigo-300/10 dark:group-hover:stroke-indigo-400" />}
  title={'AI Eval Scorer Quickstart'}
>
Score AI outputs with inline guardrails, LLM-as-a-judge, and deferred scorers.
</Card>
