...
image: "/assets/docs/examples/ai-agents/ai-in-production-post.png",
icon: RobotIcon,
...
image: "/assets/docs/examples/ai-agents/a16z-ai-podcast.png",
icon: RobotIcon,
...
image: "/assets/docs/examples/ai-agents/automate-all-of-your-customer-interactions-video.png",
icon: RobotIcon,
...
image: "/assets/docs/examples/ai-agents/semi-autonomous-agents-post.png",
icon: RobotIcon,
