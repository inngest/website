...
<Example example={{
  ...
  description: "Get started sending customer lifecycle emails with Resend and Inngest. Get started sending customer lifecycle emails with Resend and Inngest.",
  pattern: 1,
  demo: "/docs/guides/resend-webhook-events",
  github: "/docs/guides/resend-webhook-events",
  image: "/assets/docs/quick-start/dev-server-test-event-console.png"
}}/>
