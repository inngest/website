...
```go
!snippet:path=snippets/go/v0_8/migration/high_level.go
```
...
```go
!snippet:path=snippets/go/v0_8/migration/client.go
```
...
```go
!snippet:path=snippets/go/v0_8/migration/create_function.go
```
