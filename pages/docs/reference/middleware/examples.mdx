...
It is based on the [built-in logger middlware](/docs/reference/client/logging) in the SDK, and hope it gives you an idea of what you can do if the built-in logger doesn't meet your needs.
