...
<Callout variant="info">
  💡 Inngest currently supports Django, FastAPI, Flask, and Tornado. If you'd like support for your favorite framework please open an issue on [GitHub](https://github.com/inngest/inngest-py)!
</Callout>
...
<Callout variant="info">
  💡 The `INNGEST_DEV` env var tells the Inngest SDK to put itself in "dev mode". By default, the SDK will start in [production mode](/docs/reference/python/overview/prod-mode). We made production mode opt-out for security reasons.
