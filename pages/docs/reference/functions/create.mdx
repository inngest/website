  ...
  <Property name="throttle" type="object">
    ...
    <Properties nested={true} collapse={true}>
      ...
      <Property name="burst" type="number">
        The number of runs allow to start in the given window in a single burst. This defaults to 1, which ensure that requests are smoothed amongst the given `period`.
      </Property>
      <Property name="key" type="string">
