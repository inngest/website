  ...
  <Property name="throttle" type="object">
    ...
    <Properties nested={true} collapse={true}>
      ...
      <Property name="burst" type="number">
        The number of runs allowed to start in the given window in a single burst. This is added on top of the limit, which ensures high throughput within the period.
      </Property>
      <Property name="key" type="string">
