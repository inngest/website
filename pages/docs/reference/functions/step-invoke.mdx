    ...
    <Properties>
      ...
      <Property name="options" type="object" required>
        ...
        <Properties nested={true}>
          <Property name="function" type="string | InngestFunction" required>
            Either the ID or the local instance of the function to invoke.
          </Property>
          <Property name="data" type="object">
            Optional data to pass to the invoked function.
          </Property>
