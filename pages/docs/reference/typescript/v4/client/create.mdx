...
<Properties>
  ...
  <Property name="endpointAdapter" type="InngestEndpointAdapter.Like">
    An endpoint adapter that enables [Durable Endpoints](/docs/reference/typescript/durable-endpoints).  When provided, `inngest.endpoint()` and `inngest.endpointProxy()` become available.
  </Property>
</Properties>
