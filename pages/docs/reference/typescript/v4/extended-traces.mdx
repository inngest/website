...
<Card
  ...
  title={'Set up an OpenTelemetry client with Inngest or create custom spans'}
>
  Follow this guide to set up OpenTelemetry for AI metadata extraction, Extended Traces, and custom spans, including CommonJS and ESM preload examples.
</Card>
