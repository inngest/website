...
Check out the [Common Actions Middleware Example](/docs/reference/typescript/v4/middleware/examples#common-actions-for-every-function?ref=migration) for the code.
...
For more information, see [Defining Event Payload Types](/docs/reference/typescript/v4/client/create#defining-event-payload-types?ref=migration).
