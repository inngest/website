import { Info, Tip } from "src/shared/Docs/mdx";
...
Read the migration guide at https://www.inngest.com/docs/reference/typescript/v4/migrations/v3-to-v4 and apply every breaking change to this codebase. Pay special attention to:
...
const inngest = new Inngest({
  id: 'my-app',
  checkpointing: {
    maxRuntime: '50s', // 50s might be a good option if your max duration was 60s
  }
})
```
