...
|------|-------------------|-------------|
| `inngest.ai` | AI Metadata | LLM/AI metadata, including input/output tokens, model, latency, and cost when available |
...
The TypeScript SDK's automatic extraction of AI metadata from OpenTelemetry spans is enabled by default. Set `aiMetadata: false` on the [Inngest client](/docs/reference/typescript/v4/client/create#aiMetadata) to opt out.
