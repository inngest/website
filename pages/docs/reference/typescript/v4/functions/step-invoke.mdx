...
<Callout>
  Use the [`invoke()` trigger helper](/docs/reference/typescript/v4/functions/triggers#invoke) to define a typed schema for `step.invoke()` input data on the target function.
</Callout>
