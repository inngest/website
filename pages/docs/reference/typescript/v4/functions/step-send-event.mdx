...
<Callout>
  Use [`eventType().create()`](/docs/reference/typescript/v4/functions/triggers#with-inngestsend-and-stepsendevent) to build fully typed event payloads for `step.sendEvent()`.
</Callout>
