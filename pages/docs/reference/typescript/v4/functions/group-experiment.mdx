...
<Properties>
  ...
  <Property name="experimentRef" type="ExperimentRef">
    A stable handle to the selected variant (`{ experimentName, variant }`). Pass it to [`inngest.score.experiment()`](/docs/reference/typescript/v4/functions/scoring) or [`defer()`](/docs/reference/typescript/v4/functions/scoring) to attach a score to this experiment.
  </Property>
</Properties>
