  ...
  <Property name="options" type="object" required>
    <Properties nested>
      ...
      <Property name="experiment" type="ExperimentRef">
        An [`experimentRef`](/docs/reference/typescript/v4/functions/group-experiment) returned by `group.experiment()`. When the deferred function is a scorer, its returned score is attributed to the selected experiment variant.
      </Property>
    </Properties>
  </Property>
</Properties>
