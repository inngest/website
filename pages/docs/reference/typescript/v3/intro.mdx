...
<Info>
  There's a newer stable version available. See the [v3 to v4 migration guide](/docs/reference/typescript/v4/migrations/v3-to-v4) to upgrade.
</Info>
...
If you'd like to upgrade to v4, see the [v3 to v4 migration guide](/docs/reference/typescript/v4/migrations/v3-to-v4).
