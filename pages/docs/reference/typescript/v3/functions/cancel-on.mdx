...
The API for this is similar to the [`step.waitForEvent()`](/docs/learn/inngest-steps#wait-for-event) tool, allowing you to specify the incoming event and different methods for matching pieces of data within.
