    ...
    <Properties>
      ...
      <Property name="handler" type="function" required>
        ...
        * Any function that returns a [`Promise`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)
        ...
        Throwing errors within the handler function will trigger the step to be retried ([reference](/docs/features/inngest-functions/error-retries/inngest-errors)).
      </Property>
    </Properties>
  </Col>
  <Col>
