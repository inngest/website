...
<Row>
  <Col>
    **[v3 Reference (current)](/docs/reference/typescript/v3/functions/create)** - Stable release documentation
  </Col>
  <Col>
    **[v4 Reference (beta)](/docs/reference/typescript/v4/functions/create)** - Next major version with simplified APIs. See the [migration guide](/docs/reference/typescript/v4/migrations/v3-to-v4).
  </Col>
</Row>
...
If you'd like to upgrade, see the [v2 to v3 migration guide](/docs/reference/typescript/v3/migrations/v2-to-v3) or the [v3 to v4 migration guide](/docs/reference/typescript/v4/migrations/v3-to-v4).
