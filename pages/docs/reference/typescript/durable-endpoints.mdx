...
- [Durable Endpoints Guide](/docs/learn/durable-endpoints) - High-level guide with use cases
- [step.run()](/docs/reference/functions/step-run) - Run and checkpoint functions
- [step.sleep()](/docs/reference/functions/step-sleep) - Pause execution
- [step.waitForEvent()](/docs/reference/functions/step-wait-for-event) - Wait for external events
