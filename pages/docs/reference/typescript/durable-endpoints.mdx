...
Durable Endpoints behave like regular API endpoints upon a success path. You can request them from your front-end (_or back-end_) using `fetch()` or your favorite query or http library:
