...
<Properties>
  ...
  <Property name="loader" type="function">
    An async function receiving the [`event`](/docs/reference/typescript/v4/functions/create#event) as unique argument and returning a valid [`Workflow` instance](/docs/reference/workflow-kit/workflow-instance) object.
  </Property>
