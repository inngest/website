...
The Workflow Kit integrates with our [TypeScript SDK](/docs/reference/typescript/intro).

To use it, you'll need an application with [Inngest set up](/docs), ready to [serve Inngest functions](/docs/learn/serving-inngest-functions).
