...
<Properties>
  <Property name="event" type="TriggerEvent">
    See the Inngest Function handler [`event` argument property definition](/docs/reference/typescript/v4/functions/create#event).
  </Property>
  <Property name="step" type="Step">
    See the Inngest Function handler [`step` argument property definition](/docs/reference/typescript/v4/functions/create#step).
  </Property>
