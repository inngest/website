  ...
  <Property name="data" type="object" attribute>
    ...
    <Properties nested>
      ...
      <Property name="function_id" type="string" attribute>
        The failed function's [`id`](/docs/reference/typescript/v4/functions/create#configuration).
      </Property>
      <Property name="run_id" type="string" attribute>
        The failed function's [run ID](/docs/reference/typescript/v4/functions/create#run-id).
      </Property>
    </Properties>
  </Property>
...
* [TypeScript SDK: onFailure handler](/docs/reference/typescript/v4/functions/handling-failures)
