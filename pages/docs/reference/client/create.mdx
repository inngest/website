...
As with any secret, it is not a good practice to hard code your Event Key. We recommend setting the `INNGEST_EVENT_KEY` over passing the `eventKey` option to the Inngest client.
