...
| `rerun <run_id>` | Rerun a function from the beginning or from a selected step |
...
- `--from-step <step_id>` starts a rerun from the given user-defined step ID
- `--input '<json_array>'` replaces the selected step's input
...
- [Rerun function runs](/docs/platform/manage/rerun-function-runs?ref=docs-cli) from the beginning or from a selected step
