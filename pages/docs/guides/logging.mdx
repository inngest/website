...
There is a built-in [logging middlware](/docs/reference/middleware/examples#logging) that provides a good default to work
with.

### child logger

If the logger library supports a child logger `.child()` implementation, the built-in middlware will utilize it to add
