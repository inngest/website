...
while the [Bulk Cancellation UI](/docs/platform/manage/bulk-cancelation), available from the Platform, provides a quick way to cancel unwanted Function runs.
