...
Throttling allows you to specify how many function runs can start within a time period.  When the limit is reached, new function runs over the throttling limit will be _enqueued for the future_.  This smooths how often functions start running in a given time period.
