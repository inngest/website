...
<CodeGroup>
```go
!snippet:path=snippets/go/docs/multi_step_functions/v1/send_activation_email_function.go
```
</CodeGroup>
...
```go
!snippet:path=snippets/go/docs/multi_step_functions/v2/send_activation_email_function.go
```
...
<CodeGroup>
```go
!snippet:path=snippets/go/docs/multi_step_functions/v3/send_activation_email_function.go
```
</CodeGroup>
...
<CodeGroup>
```go
!snippet:path=snippets/go/docs/multi_step_functions/v4/send_activation_email_function.go
```
</CodeGroup>
