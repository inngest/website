import IconConcurrency from '@/shared/icons/FlowControl/Concurrency';
import IconThrottle from '@/shared/icons/FlowControl/Throttle';
import IconRateLimit from '@/shared/icons/FlowControl/RateLimit';
import IconDebounce from '@/shared/icons/FlowControl/Debounce';
import IconPriority from '@/shared/icons/FlowControl/Priority';
import IconIdempotency from '@/shared/icons/FlowControl/Idempotency';
import IconBatching from '@/shared/icons/FlowControl/Batching';
...
### <a href="/docs/guides/rate-limit" className="flex items-center gap-4"><IconRateLimit size="2rem" /> Rate Limiting</a> {{anchor: false}}
...
Avoid unnecessary function invocations by de-duplicating events over a sliding time window.
