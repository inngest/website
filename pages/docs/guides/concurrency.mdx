...
- **Setting individual function concurrency limits**, for example limiting a function run's total capacity.
...
<Properties>
  <Property name="limit" type="number" required>
    ...
    The maximum value is dictated by your accout's plan.
  </Property>
  <Property name="scope" type="'account' | 'env' | 'fn'">
    ...
    * `fn` (default):  only this function's runs affects the concurrency limit
