...
{/_TODO - New graphic in similar design style ![Relay graphic](/assets/docs/platform/replay/featured-image.png)_/}
...
{/_TODO - Link to revised fan-out guide above when complete_/}
...
{/_TODO - This should link to a future iteration of the fan-out guide which is 1 event, n functions_/}
