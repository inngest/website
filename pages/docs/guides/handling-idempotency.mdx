...
{/*TODO - New graphic in a similar design style to `/assets/docs/platform/replay/featured-image-v2.png`. */}
...
<Callout>
  ...
  * [`rateLimit`](/docs/reference/typescript/v4/functions/rate-limit) - Limit the number of function executions per period of time
