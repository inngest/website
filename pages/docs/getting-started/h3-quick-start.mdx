...
<details>
  <summary><strong>Instructions for creating a new H3 project</strong></summary>
...
<Callout>
👉 Note that you can import a [`serve`](/docs/reference/typescript/v4/serve) handler for other frameworks and the rest of the code remains the same. These adapters enable you to change your web framework without changing any Inngest function code (ex. instead of `inngest/h3` it could be `inngest/next` or `inngest/express`).
</Callout>
