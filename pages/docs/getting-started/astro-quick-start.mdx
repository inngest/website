...
```
```shell {{ title: "yarn" }}
yarn dlx inngest-cli@latest dev -u http://localhost:4321/api/inngest
```
```shell {{ title: "pnpm" }}
pnpm dlx inngest-cli@latest dev -u http://localhost:4321/api/inngest
```
```shell {{ title: "bun" }}
bunx inngest-cli@latest dev -u http://localhost:4321/api/inngest
```
</CodeGroup>
