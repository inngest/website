...
export const description =
  `Learn how to integrate Inngest to your Next.js app in 10 minutes.`

# Next.js Quick Start

Next.js by Vercel is an open-source web development framework that enables React-based web applications. This tutorial describes how to add Inngest to a Next.js application, demonstrating how to build complex, event-driven workflows and serverless functions.

In 10 minutes, you'll learn how to use Inngest for tasks like scheduling drip marketing campaigns, creating payment flows, or orchestrating LLM interactions.

By the end of this quick start guide, you will:
- Set up and run Inngest on your machine.
- Write and deploy your first Inngest serverless function.
- Trigger your function from both your Next.js app and the Inngest Dev Server.
- Understand the basics of event-driven architecture in a Next.js context.

<Callout type="info">
    New to Inngest? Check out [How Inngest Works](https://www.inngest.com/product/how-inngest-works) for a quick overview before you begin.
</Callout>
...
<img
  ...
  alt="Inngest Dev Server interface showing no recorded events"
/>
...
You will now send an event from inside your code: from the “hello” Next.js API function. To do so, create a new API handler at the <GuideSection show="nextpages">`./pages/api/hello.ts`</GuideSection><GuideSection show="nextappdir">`src/app/api/hello/route.ts`</GuideSection> file:
