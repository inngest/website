...
<Info>
Inngest does not actively manage self-hosted instances or provide guaranteed support for them. Issues reported on self-hosted deployments may be logged, but they are not prioritized this quarter.
