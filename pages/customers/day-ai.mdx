...
![on the left, incoming webhooks from GCal, at the center Day AI with Inngest, on the right, Recall.ai for bot fleet and Mux API](/assets/customers/day-ai/diagram-1.jpg)
...
![at the center, a two-layered Day AI block with at the top “raw data” and underneath “AI & enrichment workflows”; on the right, LLM and other 3rd party APIs.](/assets/customers/day-ai/diagram-2.jpg)
