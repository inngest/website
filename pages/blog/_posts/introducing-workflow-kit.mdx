---
heading: "Introducing Inngest's Workflow Kit"
subtitle: The fastest way to build workflow UIs
showSubtitle: true
image: /assets/blog/introducing-workflow-kit/featured-image.png
date: 2024-09-25
author: Charly Poly
disableCTA: true
---
...
![An architecture diagram of an application using Workflow kit](/assets/blog/introducing-workflow-kit/workflow-architecture-dark.png)
...
![A visual demo of the Workflow Editor UI](/assets/blog/introducing-workflow-kit/workflow-demo.gif)
...
- **Explore** our [complete and deployable demo of CMS automations](https://github.com/inngest/workflow-sdk/tree/main/examples/nextjs-blog-cms#readme)
- **Contribute** to the [open-source repository](https://github.com/inngest/workflow-sdk)
