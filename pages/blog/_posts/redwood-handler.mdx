...
<aside>To get started right away, check out our <a href="/docs/frameworks/redwoodjs">RedwoodJS Framework Guide</a> or the <a href="https://github.com/inngest/sdk-example-redwoodjs-vercel">inngest/sdk-example-redwoodjs-vercel</a> repo.</aside>

Like [all of our other handlers](https://www.inngest.com/docs/functions#serving), the Redwood handler is simple to use.
