...
- [How event-driven workflow engines work](#how-inngest-works)
...
Here's an example of a billing function written as a workflow using [Inngest](https://www.inngest.com):
...
From there, Inngest works as expected:  we push a job into a queue so that workflows can be executed
reliably.
