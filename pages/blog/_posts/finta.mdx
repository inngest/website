...
- With `invoke` and [middleware functions](https://www.inngest.com/docs/reference/middleware/overview), you can build complex workflows that follow DRY programming. 
