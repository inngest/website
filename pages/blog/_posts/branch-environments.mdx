...
**Today, we're excited to announce that we're bringing Branch Environments to all Inngest users!** We're launching with built-in support for our Vercel integration and opt-in support for any other platform, including Netlify, Cloudflare Pages, Railway and more!
...
<CTACallout
  text="Learn more about Branch Environments in the Inngest documentation"
  cta={{
    href: "/docs/platform/environments?ref=blog-branch-environments",
    text: "Read the docs"
  }}
/>
