---
heading: Inngest Raises $3M Seed led by GGV Capital
subtitle: New round led by Glenn Soloman of GGV, including Guillermo Rauch and Tom Preston-Werner
...
**Today, we're thrilled to announce that Inngest has raised $3M in new funding led by Glenn Solomon of [GGV Capital](https://www.ggvc.com/), Guillermo Rauch of Vercel, and Github founder, Tom Preston-Werner, with continued participation from [Afore Capital](https://www.afore.vc/) and Comma Capital, plus other strategic partners.**
...
<Blockquote
  text="Inngest is the missing piece of the trend we've been seeing of developer-led, framework-defined infrastructure. You start with a great dev experience, a framework like Next, and then the complexity of the cloud goes away."
