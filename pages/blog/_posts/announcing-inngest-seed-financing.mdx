...
We invite you to give Inngest a try with [our quick start guide](/docs/getting-started/nextjs-quick-start?ref=blog-seed-announcement) and [join our community](/discord?ref=blog-seed-announcement) for questions and sharing feedback with the team!