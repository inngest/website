...
<!-- 1 [Scaling Celery to handle workflows and multiple queues by Lokesh Sanapalli](https://lokesh1729.com/posts/scaling-celery-to-handle-workflows-and-multiple-queues/), 2 [Ensuring reliability in Django Celery tasks: a comprehensive guide by Flávio Juvenal](https://www.vintasoftware.com/blog/guide-django-celery-tasks) -->
