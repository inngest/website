---
heading: "Introducing AgentKit and step.ai:  AI orchestration at scale"
...
- A new set of core APIs in our platform: [step.ai](http://step.ai/), which brings the same world-class developer experience from our existing product to AI-native applications.

Just as Inngest manages your background jobs, webhooks, and scheduled tasks with built-in retries and state management, [step.ai](http://step.ai/) now handles your AI model calls with the same production-ready infrastructure — with built in observability and support for agentic workflows out of the box.
...
<a href="/docs/agent-kit/overview">You can read the docs here</a>.  We cannot wait to see how you work with AgentKit.  We're iterating daily, and to speak with us or give feedback <a href="https://www.inngest.com/discord?ref=agentkit-blog"> join us in our #ai discord</a>
...
If you’ve already experimented with AI, you’re probably using an SDK like OpenAI’s, Anthropics, or Vercel’s AI SDK.  `step.ai.wrap` is designed to seamlessly wrap your existing AI SDK to with steps and AI observability:
...
We’re excited to see what you build with `step.ai`!
