...
If you’re familiar with both Astro and Inngest, you can read about [how to set up the Inngest API in Astro](/docs/sdk/serve#framework-astro) or explore [the Inngest and Astro 'Hello World' example](https://github.com/inngest/inngest-js/tree/main/examples/framework-astro).
