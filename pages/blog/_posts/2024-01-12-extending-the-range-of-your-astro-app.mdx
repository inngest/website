...
If you’re familiar with both Astro and Inngest, you can read about [how to set up the Inngest API in Astro](/docs/learn/serving-inngest-functionsving-inngest-functions#framework-astro) or explore [the Inngest and Astro 'Hello World' example](https://github.com/inngest/inngest-js/tree/main/examples/framework-astro).
