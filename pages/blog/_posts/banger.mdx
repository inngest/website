...
In the code snippet above, you can see that we're using the default Inngest concurrency and we set a graceful flow termination strategy in the `onFailure` function (please keep in mind that it's simplified for this blog post).
