...
Today, we're excited to release one of our [most requested features](https://roadmap.inngest.com/roadmap): the **Function Run Search**. We've had this \[in our beta program\](LINK) for a few weeks with hugely positive feedback.   
...
- **Event properties**, such as finding all runs triggered by specific event data (across one or all functions)   
...
<CTACallout text={'Get your hands on the next Inngest features'} cta={{ href: '/docs/getting-started/nextjs-quick-start?ref=blog-announcing-function-runs-search', text: 'Join the Beta Program' }} />
