...
- [Xata](https://xata.io/) with their managed Postgres,
- [Prisma](https://www.prisma.io/) with their battle-tested ORM and database management tooling,
- [Clerk](https://clerk.com/), which is already a standard for identity and authentication,
...
We're excited to see what you will bring!
